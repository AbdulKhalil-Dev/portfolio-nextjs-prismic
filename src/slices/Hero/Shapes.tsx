    ...
    <div className="row-span-1 row-start-1 -mt-9 aspect-square md:col-span-1 md:col-start-2 md:mt-0">
      ...
      >
        <Suspense fallback={null}>
          ...
          <pointLight position={[0, 10, 5]} intensity={1.5} color="#0f1ffc" />
          <pointLight position={[-5, 5, -5]} intensity={1.0} color="#fab170" />
...
const STATIC_GEOMETRIES = [
  ...
  new THREE.CapsuleGeometry(0.5, 1.5, 2, 8),
...
const STATIC_MATERIALS = [
  ...
  new THREE.MeshStandardMaterial({ color: 0xa4b0be, roughness: 0.5,  metalness: 1.0 }),
];
